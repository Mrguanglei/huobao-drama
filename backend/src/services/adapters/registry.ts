...
import { EvoLinkImageAdapter } from './evolink-image'
import { EvoLinkVideoAdapter } from './evolink-video'
...
export const imageAdapters: Record<string, ImageProviderAdapter> = {
  ...
  evolink: new EvoLinkImageAdapter(),
...
export const videoAdapters: Record<string, VideoProviderAdapter> = {
  ...
  evolink: new EvoLinkVideoAdapter(),
